			...
			<div class="x_content">
				...
				<table id="datatable-buttons" class="table table-striped table-bordered">
					...
					<tbody>
						...
						<?php foreach($table_jenis_bhp as $s){ ?>
						<tr>
							<th scope="row"><?= $sn ?></th>
							<td><?php echo $s->nama ?></td>
							<td style=" text-align: center;">
								<?php echo anchor('example/edit_form_jenis_bhp/'.$s->id, '<button class="btn btn-info btn-xs" type="button"><span class="fa fa-pencil"></span></button>'); ?>
